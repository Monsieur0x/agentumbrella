"""
🤖 QA Manager — ИИ-агент для управления командой тестировщиков.
...
async def main():
    ...
    if DEBUG_TOPICS:
        print("🔍 РЕЖИМ ОТЛАДКИ ТОПИКОВ — бот будет показывать ID каждого топика")
        print("   Напишите в каждый топик, запишите ID, затем выключите DEBUG_TOPICS")
    else:
